...
if __name__ == "__main__":
    ...
    alpha_league.add_result("Jackson", "Green", "W")
    alpha_league.add_result("Green", "Jackson", "L")
    ...
    alpha_league.victory_points[1] = 24 + 13 + 19 + 19 # Green's VP
    ...
    bravo_league.victory_points[6] = 28  + 6 # Charlie's VP
